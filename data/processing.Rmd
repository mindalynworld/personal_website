...
```{r}
palette <- c("#C3AFFC", "#CDE8B5", "#FFC864")
...
stackedAreaQu <- ggplot(data_long, aes(x=year, y=proportion, fill=category)) + 
    ...
    theme(text = element_text(size=12,  family="Avenir"), 
          ...
          axis.title.y = element_text(margin=margin(r = 15), color="#808080"),
          axis.title.x = element_text(margin=margin(t = 10), color="#808080"),
